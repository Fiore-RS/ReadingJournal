  ...
  return (
    <div className="w-full h-full overflow-y-auto">
      <div className="w-full box-border px-4 sm:px-8 lg:px-12 pt-6 sm:pt-9 pb-16">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3.5 mt-4 mb-1.5">
        ...
        {!error && books !== null && !hasBooks && (
          <div className="text-center py-[70px] text-driftwood font-body">
            ...
            <div className="text-lg">{search ? "No books match your search." : "Nothing on the wishlist yet — check back later!"}</div>
          </div>
        )}
